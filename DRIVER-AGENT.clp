...
(defrule AGENT::rsclcb
    ...
    (ag_bel (bel_type moment) (bel_pobj ?road1) (bel_pname partof) (bel_pval intersection))
    (ag_bel (bel_type moment) (bel_pobj ?road2) (bel_pname partof) (bel_pval intersection))
